...
import StepperLinearWithValidation from "common/components/Stepper/StepperLinearWithValidation";
...
const SaasClassic = () => {
  ...
  return (
    <ThemeProvider theme={saasClassicTheme}>
      <Fragment>
        <Head>
          <title>{locale === "ar" ? "سيستمها" : "Systemha"}</title>
          <meta name="Description" content="React next landing page" />
          <meta name="theme-color" content="#12805D" />
          {/* Load google fonts */}
          {/* <link
